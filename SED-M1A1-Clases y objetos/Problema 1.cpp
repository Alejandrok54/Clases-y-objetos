...
class Empleado{
	...
	void menu(){
		Empleado JefePlanta(1,"Alejandro Diaz Ortiz"),JefePersonal(2,"Ramon Rodriguez");
		int op,ce;
		string dato;
		float sueldo;
		...
		do{
			...
			cout<<"4. Cambiar el nombre de a quien reporta un empleado\n";
			cout<<"5. Salir\n";
			cout<<"Opcion: ";cin>>op;
			
			switch(op){
				case 1:
					cout<<"Ingrese la clave del empleado: ";cin>>ce;
					if(ce==1){
